...
namespace MuseumManagement.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(MuseumManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCity,CityName")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCity,CityName")] City city)
        {
            if (id != city.IdCity)
            {
                return NotFound();
