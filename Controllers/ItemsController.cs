...
namespace MuseumManagement.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(MuseumManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdItem,ItemName,ItemYear")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdItem,ItemName,ItemYear")] Item item)
        {
            if (id != item.IdItem)
            {
                return NotFound();
