...
namespace MuseumManagement.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(MuseumManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCountry,CountryName")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCountry,CountryName")] Country country)
        {
